...
document.addEventListener('DOMContentLoaded', function () {
  var listaRecetasHome = document.querySelector('.container .row');
  function cargarRecetasHome() {
    return _cargarRecetasHome.apply(this, arguments);
  }
  function _cargarRecetasHome() {
    _cargarRecetasHome = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var token, respuesta, data, recetasHome;
