...
var Auth = /*#__PURE__*/function () {
  ...
  return _createClass(Auth, [{
    key: "logIn",
    value: function () {
      var _logIn = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(correo, contrasena) {
        var response, data, currentTime;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 7:
              data = _context.sent;
              currentTime = Date.now(); // hora actual en milisegundos
            ...
            case 17:
              ...
              console.error("Error en la solicitud de inicio de sesión:", _context.t0);
...
function _handleLogin() {
  _handleLogin = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
    var correo, contrasena, auth, responseStatus;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          auth = new Auth();
          _context2.next = 9;
          return auth.logIn(correo, contrasena);
        case 9:
          ...
          if (responseStatus === 200) {
            ...
            setTimeout(function () {
              var prueba = function prueba(token) {
...
window.onload = function () {
  ...
  if (token && loginTime) {
    ...
    var hourInMilliseconds = 60 * 60 * 1000; // una hora en milisegundos
...
function showLoginMessage(message, type) {
  ...
  loginMessage.className = "alert alert-".concat(type);
