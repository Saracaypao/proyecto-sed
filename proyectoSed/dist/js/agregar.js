...
function decodeToken(token) {
  var payload = token.split('.')[1]; // obteniendo la parte central del token
  var decoded = JSON.parse(atob(payload)); // decodificando base64
  return decoded;
}
document.addEventListener('DOMContentLoaded', function () {
  ...
  var correoUsuario = decoded.correo;
  var form = document.querySelector('form');
  if (form) {
    form.addEventListener('submit', /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
        var nombreReceta, ingredientesRaw, preparacion, categoria, porciones, descripcion, ingredientes, receta, response, error, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              ingredientesRaw = document.getElementById('ingredientes').value.trim();
              preparacion = document.getElementById('preparacion').value;
              categoria = document.getElementById('categoria').value;
              porciones = document.getElementById('porciones').value;
              descripcion = document.getElementById('descripcion').value; // procesa los ingredientes para asegurarse de que sea un array no vacío
              ingredientes = ingredientesRaw ? ingredientesRaw.split('\n').map(function (i) {
                return i.trim();
              }).filter(function (i) {
                return i.length > 0;
            ...
            case 11:
              ...
              _context.prev = 12;
              _context.next = 15;
              return fetch('http://localhost:3000/api/recipe/newRecetas', {
                method: 'POST',
                headers: {
